...
function ContactUs() {
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 smLgap-5 max-w-2xl w-full'>
            <div className=''>
            ...
            <div className='sm:col-span-2'>
              ...
              w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' required />
            </div>
