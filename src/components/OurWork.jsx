...
const OurWork = () => {
    ...
    const workData = [
        {
            ...
            description: 'We turn bold ideas into powerful digital soulution that connect, engage...',
  ...
  return (
    <div id='our-wrok' className='flex flex-col items-center gap-7 px-4 sm:px-12
    lg:px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
