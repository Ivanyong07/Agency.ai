  ...
  return (
    ...
    px-4 sm:px-10 lg:px-24 xl:px-40'>
      ...
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        ...
        <div className='text-gray-600 dark:text-gray-400'>
          ...
          <div className='flex gap-2 text-sm'>
            ...
            p-3 text-sm outline-none reounded dark:text-gray-200 bg-transparent
            border border-gray-300 dark:border-gray-500'/>
            <button className='bg-primary text-white rounded-full px-6'>Subscribe</button>
          </div>
      ...
      <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
        <p>Copyright 2025 C GreatStack - All Right Reserved.</p>
